...
const PortfolioForm: NextPage = ({ onSubmit }) => {
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="form-group">
        ...
        {errors.title && (
          <Alert variant="danger">
            ...
            {errors.title?.type === 'firstLetterUpper' && (
              <p>First letter should be uppercased!</p>
            )}
          </Alert>
        )}
      </div>
      ...
      <div className="form-group">
        ...
        <input
          ...
          id="location"
        />
        {errors.location && <Alert variant="danger">Some Error</Alert>}
      </div>
